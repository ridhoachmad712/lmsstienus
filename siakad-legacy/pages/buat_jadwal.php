            ...
            <div class="card-body">
              <table>
                <tr>
                  ...
                  <td><a class="btn btn-green" data-bs-toggle="modal" data-bs-target="#modal-scrollable" style="text-decoration: none;">Buat Penjadawalan</a></td>
                </tr>
              </table>
            </div>
          ...
          if (isset($_POST['filter'])) {
            ...
            while ($t_jadwal=mysqli_fetch_array($jadwal)) {
              ...
              <tr>
                ...
                <td style="text-align: center;"><a href="buat_jadwal?id=<?= $id_jadwal; ?>&aksi=hapus&id_thn_akademik=<?= $id_thn_akademik; ?>" onclick="return confirm('Hapus data ini?')">
