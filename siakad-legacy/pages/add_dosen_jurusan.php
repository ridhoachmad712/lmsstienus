...
if (isset($_POST['tambah'])) {
  ...
  for($x=0;$x<$jumlah_dipilih;$x++){
    ...
    $update=mysqli_query($koneksi,"UPDATE user SET kode_prodi='$kode_prodi' WHERE username='$nip[$x]'");
...
if (isset($_POST['update'])) {
  ...
  $update=mysqli_query($koneksi,"UPDATE dosen SET nama_dosen='$nama_dosen', id_jk='$id_jk', id_agama='$id_agama', alamat='$alamat', tmp_lhr_dosen='$tmp_lhr_dosen', tgl_lhr_dosen='$tgl_lhr_dosen' WHERE nip='$nip'");
  if ($update == 1) {
