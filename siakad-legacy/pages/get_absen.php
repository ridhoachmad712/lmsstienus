...
if (isset($_POST['simpan_nilai'])) {
  ...
  for($j=0;$j<$jumlah_dipilih;$j++){
    // rumus
    $nilai_akhir[$j]=($nilai_uas[$j]*0.35)+($nilai_uts[$j]*0.35)+($nilai_tgs[$j]*0.30);
    // 
    ...
    mysqli_query($koneksi,"UPDATE khs_mhs SET nilai_tgs='$nilai_tgs[$j]', nilai_uts='$nilai_uts[$j]', nilai_uas='$nilai_uas[$j]', nilai_akhir='$nilai_akhir[$j]', bobot='$hasil_bobot[$j]', grade='$hasil_grade[$j]' WHERE nim_npm='$nim_npm[$j]' AND kode_prodi='$kode_prodi' AND id_jadwal='$id_jadwal' AND id_thn_akademik='$id_thn_akademik'");
    echo "<script>window.alert('Nilai berhasil disimpan !!!')
                          ...
                          <thead>
                            ...
                            <tr>
                              ...
                              <td>: 
                                ...
                                ?>
                                <?= $mk['nama_matkul']; ?> - Semester <?= $mk['semester']; ?>
                              </td>
                            </tr>
                            <tr>
                              <th>Jam Kuliah</th>
                  ...
                  <table>
                    <tr>
                     <!--  <td><a class="btn" href="input_nilai?qwe=<?= $id_thn_akademik; ?>" style="text-decoration: none;">Kembali</a></td> -->
                      <td><input type="submit" name="simpan_nilai" class="btn btn-info" value="Simpan Absen"></td>
                    </tr>
                  </table>
                </div>
