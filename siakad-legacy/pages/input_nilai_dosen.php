        ...
        <div class="page-header d-print-none">
          <div class="row align-items-center">
            <div class="col">
              ...
              <p style="margin-top: 1em;">Halo Bapak/Ibu <strong><?= $tampil_dosen['nama_dosen']; ?></strong><br>Untuk Melakukan Input Nilai, Silakan Pilih Tahun Akademik Terlebih Dahulu.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                if (isset($_POST['filter']) OR (isset($_GET['qwe']))) {
                  ...
                  <?php }else{ ?>
                   <div class="alert btn-dark"><p><b>Perhatian Untuk Bapak/Ibu Dosen!</b><br>
                      Akses Penginputan Nilai Mahasiswa dibuka <b style="color: yellow;">Mulai Tanggal <?= tgl_indo($dari_tgl); ?> Sampai Dengan <?= tgl_indo($jadwal_input_nilai['sampai_tgl']); ?>.</b></p>
                      Demi Kelancaran Proses Rekap Akademik Mahasiswa, Silakan Menginput Nilai Sebelum Batas Waktu Yang Telah Ditentukan.
                    </div>
                  <?php }} ?>
                  <!--  -->
                  <!-- tampil data -->
                      ...
                      <td style="text-align: center;">
                          ...
                          <?php }else{ ?>
                            ...
                            if ($tgl_sekarang >= $dari_tgl AND $tgl_sekarang <= $sampai_tgl) {
                              ?>
                              <a href="get_input_nilai?qwe=<?= $id_jadwal; ?>"class="btn btn-green">Input Nilai</a>
                            <?php }else{ ?>
                              <button class="btn btn-secondary disabled">Input Nilai</button>
                            <?php } ?>
