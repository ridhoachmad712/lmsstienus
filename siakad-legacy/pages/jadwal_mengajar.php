        ...
        <div class="page-header d-print-none">
          <div class="row align-items-center">
            <div class="col">
              ...
              <p style="margin-top: 1em;">Halo Bapak/Ibu <strong><?= $tampil_dosen['nama_dosen']; ?></strong><br>Untuk Melihat Jadwal Mengajar, Silakan Pilih Tahun Akademik Terlebih Dahulu.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container-xl">
          <div class="row row-cards">
            ...
            <div class="col-12">
              <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <form action="" method="post">
                            ...
                            <thead>
                              ...
                              <tr>
                                <th></th>
                                <td><input type="submit" class="btn btn-green" value="Pilih Semester" name="filter"></td>
                              </tr>
                            </thead>
                          </table>
                        </form>
                ...
                if (isset($_POST['filter'])) {
                  ...
                  <div class="card-body">
                    <table>
                      <tr>
                        <td>
                          <!-- <a class="btn btn-yellow" href="" style="text-decoration: none;">Cetak</a> -->
                        </td>
                      </tr>
                    </table>
                  </div>
                ...
                if (isset($_POST['filter']) OR (isset($_GET['qwe']))) {
                  ...
                  <?php }else{ ?>
                   ...
                   <p>Sesuai dengan Peraturan Akademik STIE Nusantara Makassar, dosen wajib membuat Rencana Pemebelajaran Semester (RPS).
                   <br>Silakan Upload RPS Mata Kuliah anda. Berikan nama file sesuai Mata Kuliah.
                    </div>
                    <a href="https://drive.usercontent.google.com/download?id=1Qjd9Fnl69wY9-A99dPMAIX1dRMhGiH7c&export=download&authuser=0&confirm=t&uuid=bee3368b-61a2-40a7-9a72-9942a48a41a7&at=APZUnTU10Ajc7xEi8nbYH4ZjtOa2:1709613423524"
              class="btn btn-blue" style="margin-left: 10px;">
              ...
              </svg>Unduh Template RPS</a>
                    <a href="https://drive.google.com/drive/folders/1bNS_xMX2LlWvOdnlp8e2Iwv0VDngYo5v?usp=sharing"
              class="btn btn-green" target="_blank" style="margin-left: 10px;">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-upload" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <path d="M9.5 13.5l2.5 -2.5l2.5 2.5" />
                  ...
                  if (isset($_POST['filter'])) {
                    ...
                    $jadwal=mysqli_query($koneksi,"SELECT * FROM jadwal_mengajar
                      ...
                      INNER JOIN dosen ON jadwal_mengajar.nip=dosen.nip WHERE id_thn_akademik='$id_thn_akademik' AND jadwal_mengajar.nip='$username' ORDER BY nama_hari DESC, mulai_jam ASC");
                    while ($t_jadwal=mysqli_fetch_array($jadwal)) {
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="get_daftar_mahasiswa?qwe=<?= $id_jadwal; ?>" class="btn btn-outline-success" target="_blank">
                                <?php 
                                $jml_mhs=mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM khs_mhs WHERE id_jadwal='$id_jadwal'"));
                                echo $jml_mhs . " Mahasiswa";
                                ?>
                            </a>
                      </td>
                  </tr> 
                <?php }}elseif(isset($_GET['qwe'])) { 
                  ...
                  $jadwal=mysqli_query($koneksi,"SELECT * FROM jadwal_mengajar
                    ...
                    INNER JOIN tbl_ruangan ON jadwal_mengajar.kode_ruangan=tbl_ruangan.kode_ruangan
                    INNER JOIN tbl_hari ON jadwal_mengajar.id_hari=tbl_hari.id_hari
                    INNER JOIN dosen ON jadwal_mengajar.nip=dosen.nip WHERE id_thn_akademik='$id_thn_akademik' AND jadwal_mengajar.nip='$username' ORDER BY mata_kuliah.semester ASC");
                  while ($t_jadwal=mysqli_fetch_array($jadwal)) {
                    $id_jadwal=$t_jadwal['id_jadwal'];
                    ?>
