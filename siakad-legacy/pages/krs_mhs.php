      ...
      <div class="page-body">
        ...
        if (isset($_POST['filter'])) {
          ...
          <div class="alert btn-dark">
            <p>Kartu Rencana Studi Mahasiswa Angkatan <b style="color: yellow;"><?= $angkatan; ?></b></p>
          </div>
        <?php } ?>
          ...
          if (isset($_POST['filter'])) {
            ...
            while ($row=mysqli_fetch_array($dmhs)) {
              ...
              <tr>
                ...
                <td><a href="cetak/krs?qwe=<?= $id_thn_akademik; ?>&nim_npm=<?= $row['nim_npm']; ?>" target="_blank" class="btn">Lihat KRS</a></td>
              </tr>
              <?php 
            }
          }
