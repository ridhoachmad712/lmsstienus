...
<section class="d-md-none mb-3" aria-labelledby="mobile-courses-title">
    ...
    @if ($courses->isEmpty())
        <div class="card"><div class="card-body text-center py-4">
            ...
            <div class="text-secondary small mb-3">Gunakan kode yang diberikan dosen untuk bergabung.</div>
            <a href="{{ route('courses.index') }}" class="btn btn-primary w-100"><i class="ti ti-login-2 me-1"></i>Gabung Kelas</a>
        </div></div>
    @else
...
{{-- ===================== AKTIVITAS LMS ===================== --}}
<h3 class="text-secondary text-uppercase fs-5 mb-2"><i class="ti ti-device-laptop me-1"></i>Aktivitas LMS</h3>
